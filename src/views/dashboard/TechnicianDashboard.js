...
const TechnicianDashboard = () => {
  ...
  const getCustomerAnalysis = () => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}/dashboard/find-customer-analysis-technician/${cookies.auth?.userProfile?.id}`, { headers: { Authorization: `Bearer ${cookies.auth.token}` } })
      .then((response) => {
